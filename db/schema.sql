...
\restrict paUkbUnyhK5Vdh0GaUmbezmlqMpskum2PAy2qM807r5SVfxaJu13OfmHFjNfG4N
...
--
-- Name: _coerce_color_24bit_text(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public._coerce_color_24bit_text(p_txt text) RETURNS integer
...
--
-- Name: _flows_color_biut(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public._flows_color_biut() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
  v_txt text;
...
--
-- Name: audit_basic(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.audit_basic() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
...
--
-- Name: audit_log_row(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.audit_log_row() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
declare
  jwt json;
...
--
-- Name: block_suspect_flow_inserts(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.block_suspect_flow_inserts() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
declare
...
--
-- Name: clear_flow_import_status(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.clear_flow_import_status() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  BEGIN
  ...
  EXCEPTION WHEN OTHERS THEN
    RAISE WARNING 'Failed to clear import status for share % (flow_id: %): %',
      OLD.share_id, OLD.id, SQLERRM;
  END;
  RETURN OLD;
END;
$$;
...
--
-- Name: FUNCTION clear_flow_import_status(); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: delete_push_subscription(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.delete_push_subscription(sub_id uuid) RETURNS void
...
--
-- Name: fill_user_id(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fill_user_id() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
begin
...
--
-- Name: flow_guard_enabled(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.flow_guard_enabled() RETURNS boolean
    LANGUAGE sql STABLE
    AS $$
...
--
-- Name: fn_ai_quota_check_and_inc(uuid, date, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fn_ai_quota_check_and_inc(p_user_id uuid, p_day date, p_limit integer DEFAULT 10) RETURNS TABLE(ok boolean, count integer)
    LANGUAGE plpgsql SECURITY DEFINER
...
--
-- Name: get_due_reminders(timestamp with time zone); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_due_reminders(now_utc timestamp with time zone) RETURNS SETOF public.reminders
    LANGUAGE sql STABLE
    AS $$
...
--
-- Name: log_flow_inserts(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.log_flow_inserts() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
declare
  _claims jsonb := nullif(current_setting('request.jwt.claims', true), '')::jsonb;
...
--
-- Name: mark_reminder_status(uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.mark_reminder_status(reminder_id uuid, new_status text) RETURNS void
    LANGUAGE sql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
  update reminders
...
--
-- Name: set_app_event_email(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.set_app_event_email() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
declare jwt json;
begin
...
--
-- Name: set_app_event_user_email(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.set_app_event_user_email() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
...
--
-- Name: set_user_events_user_id(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.set_user_events_user_id() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
begin
...
--
-- Name: set_user_id_from_auth(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: tg_flows_touch_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.tg_flows_touch_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
begin
  new.updated_at = now();
...
--
-- Name: update_journal_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_journal_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  NEW.updated_at = NOW();
...
--
-- Name: update_nutrition_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_nutrition_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  NEW.updated_at = now();
...
--
-- Name: update_scheduled_notifications_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_scheduled_notifications_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  NEW.updated_at = now();
...
--
-- Name: room_broadcast_trigger(); Type: FUNCTION; Schema: realtime; Owner: -
--

CREATE FUNCTION realtime.room_broadcast_trigger() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  BEGIN
...
--
-- Name: event_shares; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: flow_generation_cache; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.flow_generation_cache (
    id bigint NOT NULL,
...
--
-- Name: TABLE flow_generation_cache; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: flow_generation_cache_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.flow_generation_cache_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: flow_generation_cache_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: flow_generation_logs; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.flow_generation_logs (
    id bigint NOT NULL,
    user_id uuid NOT NULL,
    flow_id bigint,
    input_hash text NOT NULL,
...
--
-- Name: TABLE flow_generation_logs; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: flow_generation_daily_analytics; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.flow_generation_daily_analytics AS
...
--
-- Name: flow_generation_logs_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.flow_generation_logs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: flow_generation_logs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: flow_insert_blocklist; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.flow_insert_blocklist (
    sub uuid,
    role text,
    ip inet,
...
--
-- Name: flow_insert_debug; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.flow_insert_debug (
    id bigint NOT NULL,
    at timestamp with time zone DEFAULT now() NOT NULL,
    ip inet,
    claims jsonb,
...
--
-- Name: flow_insert_debug_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.flow_insert_debug_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: flow_insert_debug_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: flow_insert_guard_flag; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.flow_insert_guard_flag (
...
--
-- Name: flow_shares; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: COLUMN flows.ai_metadata; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: flows_color_debug; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.flows_color_debug AS
 SELECT id,
    name,
    color AS color_int,
...
--
-- Name: inbox_share_items; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.inbox_share_items AS
...
--
-- Name: inbox_share_items_filtered; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: inbox_unread_count_filtered; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: nutrition_items; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: COLUMN nutrition_items.mode; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN nutrition_items.days_of_week; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN nutrition_items.decan_days; Type: COMMENT; Schema: public; Owner: -
--
...
SELECT
    ...
    NULL::boolean AS is_discoverable,
    NULL::boolean AS allow_incoming_shares,
    NULL::timestamp with time zone AS created_at,
    NULL::timestamp with time zone AS updated_at,
    NULL::bigint AS active_flows_count,
    NULL::bigint AS total_flow_events_count;
...
--
-- Name: TABLE scheduled_notifications; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: share_short_links; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.share_short_links (
    id text NOT NULL,
...
--
-- Name: user_ai_usage; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: flow_generation_cache id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: flow_generation_logs id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: flow_insert_debug id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: event_shares event_shares_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: flow_generation_cache flow_generation_cache_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: flow_generation_logs flow_generation_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: flow_insert_debug flow_insert_debug_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: flow_insert_guard_flag flow_insert_guard_flag_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: flow_shares flow_shares_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: nutrition_items nutrition_items_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: share_short_links share_short_links_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: journal_entries unique_user_date; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_ai_usage user_ai_usage_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_events user_events_user_client_event_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: app_events_user_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: event_shares_recipient_created_deleted_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: event_shares_sender_created_deleted_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: flow_shares_recipient_created_deleted_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: flow_shares_sender_created_deleted_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: flows_updated_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: flows_user_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_app_events_created_at_desc; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_app_events_event; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cache_user_hash; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_event_shares_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_event_shares_deleted_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_event_shares_recipient; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_event_shares_sender; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_flow_generation_cache_input_hash_created_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_flow_generation_logs_flow_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_flow_generation_logs_input_hash; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_flow_generation_logs_user_id_created_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_flow_shares_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_flow_shares_deleted_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_flow_shares_flow; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_flow_shares_recipient; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_flow_shares_sender; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_flow_shares_share_token; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_flow_shares_token; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_flows_share_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_flows_user_updated; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_nutrition_items_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_nutrition_items_user_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_profiles_handle; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_scheduled_notifications_active; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_scheduled_notifications_client_event_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_short_links_expires; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_short_links_share; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_user_events_client_event_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_user_events_client_event_id_like; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_user_events_prefix_starts_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_user_events_starts_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_user_events_user_starts; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_user_events_user_starts_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: nutrition_items_user_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: reminders_alert_at_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: reminders_user_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: user_events_client_event_id_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: user_events_starts_at_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: user_events_uid_client_event_id_uq; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ux_user_events_user_client_event_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: profile_stats _RETURN; Type: RULE; Schema: public; Owner: -
--
...
--
-- Name: flows clear_import_on_flow_delete; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER clear_import_on_flow_delete AFTER DELETE ON public.flows FOR EACH ROW EXECUTE FUNCTION public.clear_flow_import_status();


--
-- Name: flows flows_touch_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER flows_touch_updated_at BEFORE UPDATE ON public.flows FOR EACH ROW EXECUTE FUNCTION public.tg_flows_touch_updated_at();
...
CREATE TRIGGER journal_entries_updated_at BEFORE UPDATE ON public.journal_entries FOR EACH ROW EXECUTE FUNCTION public.update_journal_updated_at();


--
-- Name: nutrition_items nutrition_items_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER nutrition_items_updated_at BEFORE UPDATE ON public.nutrition_items FOR EACH ROW EXECUTE FUNCTION public.update_nutrition_updated_at();


--
-- Name: scheduled_notifications scheduled_notifications_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER scheduled_notifications_updated_at BEFORE UPDATE ON public.scheduled_notifications FOR EACH ROW EXECUTE FUNCTION public.update_scheduled_notifications_updated_at();


--
-- Name: app_events trg_app_events_set_user_email; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_app_events_set_user_email BEFORE INSERT ON public.app_events FOR EACH ROW EXECUTE FUNCTION public.set_app_event_user_email();


--
-- Name: app_events trg_audit_app_events; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_audit_app_events AFTER INSERT OR DELETE OR UPDATE ON public.app_events FOR EACH ROW EXECUTE FUNCTION public.fn_audit_row();


--
-- Name: flows trg_audit_flows; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_audit_flows AFTER INSERT ON public.flows FOR EACH ROW EXECUTE FUNCTION public.audit_basic();
...
CREATE TRIGGER trg_audit_profiles AFTER INSERT OR DELETE OR UPDATE ON public.profiles FOR EACH ROW EXECUTE FUNCTION public.fn_audit_row();


--
-- Name: user_events trg_audit_user_events; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_audit_user_events AFTER INSERT ON public.user_events FOR EACH ROW EXECUTE FUNCTION public.audit_basic();


--
-- Name: flows trg_block_suspect_flow_inserts; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_block_suspect_flow_inserts BEFORE INSERT ON public.flows FOR EACH ROW EXECUTE FUNCTION public.block_suspect_flow_inserts();


--
-- Name: flows trg_flows_color_biut; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_flows_color_biut BEFORE INSERT OR UPDATE ON public.flows FOR EACH ROW EXECUTE FUNCTION public._flows_color_biut();


--
-- Name: flows trg_flows_set_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_flows_set_updated_at BEFORE UPDATE ON public.flows FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: flows trg_log_flow_inserts; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_log_flow_inserts AFTER INSERT ON public.flows FOR EACH ROW EXECUTE FUNCTION public.log_flow_inserts();


--
-- Name: nutrition_items trg_nutrition_items_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_nutrition_items_updated_at BEFORE UPDATE ON public.nutrition_items FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: profiles trg_profiles_set_email_ins; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_profiles_set_email_ins BEFORE INSERT ON public.profiles FOR EACH ROW EXECUTE FUNCTION public.set_profile_email();


--
-- Name: profiles trg_profiles_set_email_upd; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_profiles_set_email_upd BEFORE UPDATE ON public.profiles FOR EACH ROW EXECUTE FUNCTION public.set_profile_email();
...
--
-- Name: push_subscriptions trg_push_subs_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: user_events trg_set_user_events_user; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_set_user_events_user BEFORE INSERT ON public.user_events FOR EACH ROW EXECUTE FUNCTION public.set_user_events_user_id();


--
-- Name: user_events trg_set_user_id; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_set_user_id BEFORE INSERT ON public.user_events FOR EACH ROW EXECUTE FUNCTION public.set_user_id_from_auth();


--
-- Name: nutrition_items trg_touch_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_touch_updated_at BEFORE UPDATE ON public.nutrition_items FOR EACH ROW EXECUTE FUNCTION public.touch_updated_at();


--
-- Name: user_events trg_user_events_set_user_id; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_user_events_set_user_id BEFORE INSERT ON public.user_events FOR EACH ROW EXECUTE FUNCTION public.set_user_id();
...
--
-- Name: event_shares event_shares_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: event_shares event_shares_recipient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: event_shares event_shares_sender_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: flows fk_flows_share_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: flow_generation_cache flow_generation_cache_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: flow_shares flow_shares_flow_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: flow_shares flow_shares_recipient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: flow_shares flow_shares_sender_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: journal_entries journal_entries_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: journal_entries journal_entries_flow_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: nutrition_items nutrition_items_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_events user_events_flow_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: event_shares Recipients can mark event shares as viewed/imported; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: flow_shares Recipients can mark shares as viewed/imported; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: event_shares Users can create event shares; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: flow_shares Users can create shares; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: flows Users can delete own flows; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_events Users can delete own rows; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: flows Users can delete their own flows; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can delete their own flows" ON public.flows FOR DELETE TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id));


--
-- Name: scheduled_notifications Users can delete their own notifications; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_events Users can insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: flows Users can insert own flows; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: flows Users can insert their own flows; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can insert their own flows" ON public.flows FOR INSERT TO authenticated WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));


--
-- Name: scheduled_notifications Users can insert their own notifications; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: nutrition_items Users can manage own nutrition items; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: flows Users can select own flows; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can select own flows" ON public.flows FOR SELECT TO authenticated USING ((auth.uid() = user_id));


--
-- Name: user_events Users can select own rows; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: flows Users can update own flows; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can update own flows" ON public.flows FOR UPDATE TO authenticated USING ((auth.uid() = user_id)) WITH CHECK ((auth.uid() = user_id));
...
--
-- Name: user_events Users can update own rows; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: flows Users can update their own flows; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can update their own flows" ON public.flows FOR UPDATE TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id)) WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));


--
-- Name: scheduled_notifications Users can update their own notifications; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: event_shares Users can view received event shares; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: flow_shares Users can view received shares; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: event_shares Users can view sent event shares; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: flow_shares Users can view sent shares; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: flows Users can view their own flows; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Users can view their own flows" ON public.flows FOR SELECT TO authenticated USING ((( SELECT auth.uid() AS uid) = user_id));


--
-- Name: scheduled_notifications Users can view their own notifications; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: app_events app_events_insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: app_events app_events_select_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: nutrition_items del_nutrition_items; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: event_shares; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.event_shares ENABLE ROW LEVEL SECURITY;

--
-- Name: event_shares event_shares_update_sender_or_recipient; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: app_events events insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: app_events events select own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: app_events events select svc; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_events events_select; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: flow_generation_cache; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.flow_generation_cache ENABLE ROW LEVEL SECURITY;

--
-- Name: flow_generation_cache flow_generation_cache_insert_service; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: flow_generation_logs; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.flow_generation_logs ENABLE ROW LEVEL SECURITY;

--
-- Name: flow_generation_logs flow_generation_logs_insert_owner; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: flow_generation_logs flow_generation_logs_select_owner; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: flow_shares; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.flow_shares ENABLE ROW LEVEL SECURITY;

--
-- Name: flow_shares flow_shares_update_sender_or_recipient; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: flows flows_delete_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY flows_delete_own ON public.flows FOR DELETE USING ((( SELECT auth.uid() AS uid) = user_id));


--
-- Name: flows flows_insert_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY flows_insert_own ON public.flows FOR INSERT WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));


--
-- Name: flows flows_insert_owned; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY flows_insert_owned ON public.flows FOR INSERT WITH CHECK ((user_id = auth.uid()));
...
--
-- Name: flows flows_select_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY flows_select_own ON public.flows FOR SELECT USING ((( SELECT auth.uid() AS uid) = user_id));


--
-- Name: flows flows_select_shared; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY flows_select_shared ON public.flows FOR SELECT USING ((id IN ( SELECT flow_shares.flow_id
   FROM public.flow_shares
  WHERE ((flow_shares.recipient_id = auth.uid()) OR (flow_shares.sender_id = auth.uid())))));


--
-- Name: flows flows_update_own; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY flows_update_own ON public.flows FOR UPDATE USING ((( SELECT auth.uid() AS uid) = user_id)) WITH CHECK ((( SELECT auth.uid() AS uid) = user_id));


--
-- Name: nutrition_items ins_nutrition_items; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: nutrition_items; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.nutrition_items ENABLE ROW LEVEL SECURITY;

--
-- Name: nutrition_items nutrition_items_delete; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: nutrition_items nutrition_items_insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: nutrition_items nutrition_items_select; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: nutrition_items nutrition_items_update; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: push_subscriptions push_subscriptions insert own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: push_subscriptions push_subscriptions select own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: push_subscriptions push_subscriptions update own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: reminders reminders delete own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: reminders reminders insert own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: reminders reminders select own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: reminders reminders update own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: nutrition_items sel_nutrition_items; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: audit_log svc can read audit; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_events ue_delete_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_events ue_insert_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_events ue_select_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_events ue_update_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: nutrition_items upd_nutrition_items; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_events user_events_delete_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_events user_events_insert_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_events user_events_insert_owned_or_imported; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_events user_events_select_direct_event_shares; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_events user_events_select_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_events user_events_select_shared_flow_events; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_events user_events_update_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_events user_events_update_owned; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_state user_state_insert_self; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_state user_state_select_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_state user_state_update_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: supabase_realtime user_events; Type: PUBLICATION TABLE; Schema: public; Owner: -
--
