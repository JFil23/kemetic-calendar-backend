...
const RECIPES: MaatFlowBriefRecipe[] = [
  ...
  },
  {
    ...
    titleNoun: "cohesion",
    sampleDays: [
      "Name one agreement as it currently stands.",
      "Bring one drifted word to direct process.",
      "Close by writing what is now explicitly true.",
    ],
    matches: (input) =>
      input.mode === "drift" && leadCorrectionAxis(input) === "C",
  },
  {
    ...
    intent: "restore",
    durationDays: 7,
    domain: "boundary / restraint",
    fallbackTemplateKey: "the-boundary-stone",
    cueType: "measure",
