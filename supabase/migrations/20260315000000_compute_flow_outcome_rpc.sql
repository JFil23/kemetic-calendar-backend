-- Phase 0: production-safe compute_flow_outcome RPC with honest proxies and telemetry gating
...
'Phase 0 flow outcome aggregation using user_events, journal entries/badges, and flow-scoped app_events telemetry. Honest proxies only; edit_count sums edits/deletes/reschedules; accepted_as_is set only when flow-scoped telemetry is present.';
