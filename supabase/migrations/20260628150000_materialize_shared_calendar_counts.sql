...
'Client-safe accepted-calendar filing summary. Event counts are materialized per request so startup calendar summaries do not recompute accepted-calendar event aggregates once per calendar row.';
