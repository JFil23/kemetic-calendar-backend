-- Keep RSVP writes independent from the best-effort invite import sync.
-- If an accepted invite cannot currently materialize a standalone calendar
-- copy, preserve the recipient's response and simply skip that import pass.
